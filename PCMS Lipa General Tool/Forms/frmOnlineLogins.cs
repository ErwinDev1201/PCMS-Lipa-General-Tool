...
namespace PCMS_Lipa_General_Tool.Forms
{
	public partial class frmOnlineLogins : Telerik.WinControls.UI.RadForm
	{
		...
		public void DisplayOnlineLoginsInfoInControls(DataRow selectedRow)
		{
			try
			{
				// Backend: Fetch attorney data
				var attorneyTable = onlineLogin.GetOnlineLoginInfo(); // Call the backend method
				...
				// Backend: Extract data
				var (loginID, insuranceName, weblink, username, password, accountowner, remarks, browser) = onlineLogin.ExtractOnlineLoginInfoFromRow(selectedRow);

					// Frontend: Display data in RadTextBox controls
					txtLoginID.Text = loginID;
					txtInsuranceName.Text = insuranceName;
		...
		// Helper method to clear RadTextBoxes
