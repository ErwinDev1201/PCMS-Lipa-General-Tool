namespace PCMS_Lipa_General_Tool
{
    partial class frmModTask
    {
        ...
        private void InitializeComponent()
        {
			...
			// cmbPriority
			// 
			radListDataItem5.Text = "High";
			radListDataItem6.Text = "Normal";
			radListDataItem7.Text = "Low";
			this.cmbPriority.Items.Add(radListDataItem5);
			this.cmbPriority.Items.Add(radListDataItem6);
			...
			// cmbCategory
			// 
			radListDataItem8.Text = "Bug";
			radListDataItem9.Text = "Feature";
			radListDataItem10.Text = "Request";
			radListDataItem11.Text = "Rejection";
			radListDataItem12.Text = "COB Billing";
			radListDataItem13.Text = "System";
