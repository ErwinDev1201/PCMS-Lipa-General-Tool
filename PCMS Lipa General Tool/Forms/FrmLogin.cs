					...
					else
					{
						...
						else if (userPosition == "Collector")
						{
							try
							{
								...
								//};
								var collectors = new frmCollectors(null, empName, userName, userAccess, empID, officeLoc, empStat, userPosition);
								//if (userPosition = "Collector")
						...
						else
						{
							try
							{
								var mainApp = new frmMainApp(empName, userName, empID, officeLoc, empStat, userPosition);
