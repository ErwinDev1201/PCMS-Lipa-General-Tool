...
namespace PCMS_Lipa_General_Tool__WinForm_
{
	...
	public partial class frmMainApp : RadForm
	{
		...
		public frmMainApp(string empName, string userName, string empID, string ofLoc, string empStat, string postition)
		{
			InitializeComponent();
...
;
		...
		private void mnuViewCollectorNotes_Click(object sender, EventArgs e)
		{
			...
			{
				//pictureBox1.SendToBack();
				var empListSelection = new frmEmpListSelection(EmpName, UserName, accessLevel, employeeID, OfficeLoc, employeeStat, Position);
                empListSelection.chkLoadmyData.Checked = true;
                empListSelection.ShowDialog();
                //var empListSelection = new frmEmployeeListSelection(EmpName, UserName, accessLevel, employeeID, OfficeLoc, employeeStat, Position);
                //var collectorNotes = new frmCollectors(EmpName, UserName, accessLevel, employeeID, OfficeLoc, employeeStat, Position);
                // isCollector = Position == "Collector";
                //collectorNotes.mnumainCollector.Visible = isCollector;
                ////	collectorNotes.mnumainCollector.Visible = false;
                ////collectorNotes.cmbEmployeeName.Visible = true;
