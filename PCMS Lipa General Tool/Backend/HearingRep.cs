...
namespace PCMS_Lipa_General_Tool.Class
{
	public class HearingRep
	{
		...
		public void GetDBID(out string ID, string empName)
		{
			...
			{
				notif.LogError("GetDBID", empName, "HearingRep", "N/A", ex);
			}
		...
		public DataTable ViewHearinRepList(string empName, out string lblCount)
		{
			...
			{
				notif.LogError("ViewHearinRepList", empName, "HearingRep", "N/A", ex);
			}
...
OR [Remarks] LIKE @searchTerm";
			...
			out string message)
		{
			...
			{
				notif.LogError($"HRRepDBRequest - {request}", empName, "Hearing Rep", repID, ex);
