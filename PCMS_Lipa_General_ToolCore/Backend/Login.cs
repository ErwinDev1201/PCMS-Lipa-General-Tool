...
namespace PCMS_Lipa_General_Tool.Class
{
	...
	bool islblAlertShow)> ProcessLoginDetailsAsync(SqlDataReader readerSQL)
		...
		//				notif.SendToastNotifDesktop(alertMessage, "Something went wrong");
		//			}
		//			catch (Exception ex)
		//			{
		//				notif.LogError("ProcessLogin", EmpName, "Login", ex.Message, ex);
...
//				//notif.SendToastNotifDesktop("Your role or access is not configured properly. Please check with Erwin.", "Error");
//				Application.Exit();
//			}
//			return false;
//		}	//
